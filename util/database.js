...
import IllegalTraffic from "../models/IllegalTraffic.js";
import IllegalTrafficAccident from "../models/IllegalTrafficAccident.js";
...
db.illegalTraffic = IllegalTraffic(sequelize, Sequelize);
db.illegalTrafficAccident = IllegalTrafficAccident(sequelize, Sequelize);

db.licenseNoHistory.hasMany(db.licenseNoHistoryDetail, {
  as: "his_detail",
  foreignKey: "lice_no_his_id",
});
